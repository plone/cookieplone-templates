"""Pytest configuration for devops_ansible template tests."""
...
def context() -> dict[str, str]:
    ...
    return {
        "title": "Ansible",
        "project_description": "Ansible setup",
        "folder_name": "ansible",
        "author_name": "Plone Community",
        "author_email": "collective@plone.org",
        "github_organization": "collective",
        "__folder_name": "ansible",
        "__repository_url": "https://github.com/collective/ansible",
        "initialize_git": "1",
    }
