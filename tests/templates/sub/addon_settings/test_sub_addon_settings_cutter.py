...
def test_creation(cookies, template_path, context: dict):
    ...
    assert result.project_path.name == "collective-addon"
...
GENERATED_FILES = [
    ...
    "backend/src/packagename/locales/de/LC_MESSAGES/collective.addon.po",
    "backend/src/packagename/locales/en/LC_MESSAGES/collective.addon.po",
    "backend/src/packagename/locales/es/LC_MESSAGES/collective.addon.po",
    "backend/src/packagename/locales/it/LC_MESSAGES/collective.addon.po",
    "backend/src/packagename/locales/pt_BR/LC_MESSAGES/collective.addon.po",
    "backend/src/packagename/locales/collective.addon.pot",
    "backend/src/packagename/locales/__main__.py",
    "backend/src/packagename/profiles/default/registry/.gitkeep",
    ...
    "frontend/Dockerfile",
    "frontend/Makefile",
    "frontend/packages/volto-collective-addon/src/config/settings.ts",
]
