...
def template_folder() -> str:
    return "projects/aurora_cmfplone"
    ...
    return annotate_context(
        {
            ...
            "frontend_addon_name": "aurora-ploneorgbr",
            "language_code": "en",
            ...
            "__node_version": "22",
            "__npm_package_name": "aurora-ploneorgbr",
            "__frontend_package_name": "aurora-ploneorgbr",
...
def context_scoped_frontend_package(context) -> dict:
    """Cookiecutter context."""
    new_context = deepcopy(context)
    new_context["frontend_addon_name"] = "@plone-collective/aurora-ploneorgbr"
    return new_context
