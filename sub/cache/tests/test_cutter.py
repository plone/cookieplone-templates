...
@pytest.mark.parametrize(
    ...
    [
        ...
        "backend/src/project.title/src/project/title/profiles/default/registry/plone.cachepurging.interfaces.ICachePurgingSettings.xml",  # noQA
        "backend/src/project.title/src/project/title/profiles/default/registry/plone.caching.interfaces.ICacheSettings.xml",  # noQA
