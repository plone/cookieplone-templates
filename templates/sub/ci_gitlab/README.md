...
This is a sub-template -- used by other templates, and to get a GitLab CI/CD based configuration -- accessible with **Cookieplone** at the path `sub/ci_gitlab`.
