# Cookieplone Aurora with Plone Backend Project 🌟
...
Welcome to **Cookieplone Aurora with Plone Backend Project**!
This template creates an Aurora frontend and Python CMFPlone backend in one repository.
...
| `frontend_base_version` | Aurora frontend container base version used to build the Aurora image.        | `1.0.0-alpha.8`    |
