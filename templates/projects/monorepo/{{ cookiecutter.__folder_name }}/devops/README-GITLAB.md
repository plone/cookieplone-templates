...
2.  Go to your repository at [{{ cookiecutter.organization }}/{{ cookiecutter.__project_slug }}](https://gitlab.com/{{ cookiecutter.organization }}/{{ cookiecutter.__project_slug }}).
