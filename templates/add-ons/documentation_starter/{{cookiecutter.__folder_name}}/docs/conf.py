...
# {{cookiecutter.title}} build configuration file
...
# html_context = {
#     "edit_page_url_template": "https://github.com/plone/plone-sphinx-theme/edit/main/docs/",
# }
...
htmlhelp_basename = "{{cookiecutter.title}}Documentation"
